        ...
        <div class="property__gallery-container container">
          <div class="property__gallery">
            <div class="property__image-wrapper">
              <img class="property__image" src="img/studio-01.jpg" width="337" height="452" alt="Photo studio">
            </div>
              <div class="property__image-wrapper">
                <img class="property__image" src="img/studio-photos.jpg" width="688" height="452" alt="Photo studio">
            </div>
              </div>
            </div>
